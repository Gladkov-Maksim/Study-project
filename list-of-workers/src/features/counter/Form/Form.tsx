import React, {useState, useRef, FC, ReactNode, HTMLAttributes} from 'react';
...
interface Form extends HTMLAttributes<HTMLDivElement>{
    title: string;
    children: ReactNode;
}

const Form : FC<Form> = ({title, children, ...props}) => {
